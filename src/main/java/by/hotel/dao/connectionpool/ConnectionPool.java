...
public final class ConnectionPool {
    ...
    /**
     * Field - givenAwayConQueue to store connections .
     */
    ...
    private ConnectionPool() {
        ...
        try {
            ...
            poolSize = 10;
            logger.info("Invalid number format", e);
        }
    }
    ...
    public void initPoolData() throws ConnectionPoolException {
        try {
            ...
            givenAwayConQueue = new ArrayBlockingQueue<>(
                    poolSize);
    ...
    public void closeConnection(Connection connection, Statement statement,
        ...
        try {
            ...
            logger.error("PreparedStatement isn't closed.", e);
        }
        try {
            connection.close();
        } catch (SQLException e) {
